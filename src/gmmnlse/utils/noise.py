...
def apply_noise_to_boundary(
    ...
    # Use a fixed small threshold for normalized boundary window (0-1 scale)
    # This is independent of signal power - just a small baseline to prevent
    # numerical issues with exactly zero values
